...
# %E5%B9%B4
code = quote('5年', encoding='utf-8')
url_ = 'http://www.csindex.com.cn/zh-CN/indices/index-detail/930606?earnings_performance={}&data_type=json'.format(code)
print(url_)
headers = {
...
print(trade_json, len(trade_json))
